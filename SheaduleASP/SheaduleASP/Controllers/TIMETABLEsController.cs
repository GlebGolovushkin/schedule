...
namespace SheaduleASP.Controllers
{
    public class TIMETABLEsController : Controller
    {
        ...
        {
            var tIMETABLE = db.TIMETABLE.Include(t => t.ACTIVITY)
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.AUDITORIUM_CODE = new SelectList(db.AUDITORIUM, "AUDITORIUM_CODE", "AUDITORIUM_NUMBER");
        ...
        public async Task<ActionResult> Create(
            [Bind(Include =
                "LESSON_CODE,WEEKDAY_CODE,COURSE_CODE,GROUP_CODE,TEACHER_CODE,DISCIPLINE_CODE,ACTIVITY_TYPE_CODE,AUDITORIUM_CODE,WEEK_NUMBER,TIME_CODE,CROSSES")]
            TIMETABLE tIMETABLE)
        {
            ...
            ViewBag.ACTIVITY_TYPE_CODE = new SelectList(db.ACTIVITY, "ACTIVITY_TYPE_CODE", "ACTIVITY_TYPE_NAME",
                tIMETABLE.ACTIVITY_TYPE_CODE);
            ViewBag.AUDITORIUM_CODE = new SelectList(db.AUDITORIUM, "AUDITORIUM_CODE", "AUDITORIUM_NUMBER",
                tIMETABLE.AUDITORIUM_CODE);
            ViewBag.DISCIPLINE_CODE = new SelectList(db.DISCIPLINE, "DISCIPLINE_CODE", "DISCIPLINE_NAME",
                tIMETABLE.DISCIPLINE_CODE);
